...
public class LeaveDetailsTest {
	...
	public void testGettersAndSetters() throws ParseException {
		...
		assertEquals("2020-10-20", sdf.format(leaveDetails.getLeaveEndDate()));
	}
	
	@Test
	public void testToString() throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		LeaveDetails ld1 = new LeaveDetails(1, 1000, sdf.parse("2020-10-10"), sdf.parse("2020-10-12"), "Sick", LeaveStatus.PENDING, LeaveType.EL);
	...
	public void testConstructor() throws ParseException {
		...
		assertEquals("2020-10-12", sdf.format(ld1.getLeaveEndDate()));
